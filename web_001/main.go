...
func main() {
	...
	s.HandleFunc("GET", "/", func(c *Context) {
		c.RenderTemplate("src/gothic/web_001/public/index.html",
	...
	s.HandleFunc("GET", "/login", func(c *Context) {
		c.RenderTemplate("src/gothic/web_001/public/login.html",
...
func AuthHandler(next HandlerFunc) HandlerFunc {
	ignore := []string{"/login", "src/gothic/web_001/public/index.html"}
