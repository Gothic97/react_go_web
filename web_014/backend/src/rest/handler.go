...
func NewHandler() (HandlerInterface, error) {
	return NewHandlerWithParams("mysql", "root:dl159147!@@tcp(127.0.0.1:3306)/gomusic")
}
...
func (h *Handler) GetMainPage(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"item": "aaa"})
	//fmt.Fprintf(c.Writer, "FSDLAGVHSO; SNpfwESD DHA ;OSD ;FE;")
}
